...
namespace test
{
    internal class IPLocator
    {
        ...
        public string ConnectionString()
        {
            ...
            string connectionString = $"Data Source=10.0.0.147,1433;Initial Catalog=MinicapstoneC;User ID=recadm;Password=pass;Encrypt=False;TrustServerCertificate=True;Connection Timeout =30;";
