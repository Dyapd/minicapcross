...
namespace test
{
    internal class IPLocator
    {
        ...
        public string ConnectionString()
        {
            ...
            string connectionString = $"Data Source=  192.168.137.1,1433;Initial Catalog=Minicapstone;User ID=recadm;Password=pass;Encrypt=False;TrustServerCertificate=True;Connection Timeout =30;";
